...
export const toAlphabetic = (num: number): string => {
    let result = '';
    while (num > 0) {
        num--;
...
export const formatNumber = (num: number, style: 'numeric' | 'roman' | 'alphabetic'): string => {
    switch (style) {
        case 'roman':
            return toRoman(num);
        case 'alphabetic':
...
export const Icon = {
    ...
    Spinner: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
};
...
export interface ApiSectionGroup {
    id: number;
    section_id: number;
    numbering_style: 'numeric' | 'roman' | 'alphabetic';
