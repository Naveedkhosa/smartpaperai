...
const Icon = {
  Close: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 极1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" /></svg>,
  Add: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1极v5h5a1 1 0 110 2h-5v5a1 1 极0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" /></svg>,
  Edit: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" /></svg>, // Fixed this line
  Delete: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2极H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" /></svg>,
  // ... rest of the icons
   Duplicate: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M7 9a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H9a2 2 0 01-2-2V9z" /><path d="M5 3a2 2 0 00-2 2v6a2 2 0 002 2V5h8a2 2 0 00-2-2H5z" /></svg>,
    ...
    Download: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 极 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-极 0 010-1.414z" clipRule="evenodd" /></svg>,
    Eye: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="极 0 20 20" fill="currentColor"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z" /><path fillRule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 极 4 4 0 018 0z" clipRule="evenodd" /></svg>,
    Edit2: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M13.586 3.586a2 2 0 112.828 2.828极l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" /></svg>,
};
...
const Modal: React.FC<{ open: boolean; onClose: () => void; title?: string } & React.PropsWithChildren<{}>> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="max-w-3xl w-full bg-white rounded-xl shadow-2xl p-6 border border-gray-200">
                <div className="flex justify-between items-center mb-4 pb-3 border-b">
                    <h3 className="text-xl font-semibold text-gray-800">{title}</h3>
                    <button onClick={onClose} className="p-1 rounded-full bg-gray极-100 hover:bg-gray-200 text-gray-600 transition-colors">
                        <Icon.Close />
                    </button>
                </div>
                <div>{children}</div>
...
const Confirm = ({ open, onConfirm, onCancel, message }: any) => (
    <Modal open极={open} onClose={onCancel} title="Confirm Action">
...
const SortableSection: React.FC<{
    ...
    onDeleteGroup: (sectionId: string, groupId: string)极 void;
            ...
            <div className="flex justify-between items-start gap-4 mb-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 cursor-pointer" onClick={() => onEdit(section)}>
                        ...
                        {section.instruction && <p className="text-gray-600 mt-1">{section.instruction}</p>}
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => onAddGroup(section.id)} className="p-2 rounded-lg bg-green-100 hover:bg-green-200 text-green-700 transition-colors" title极="Add Group">
                        <Icon.Add />
                    </button>
                    ...
                    section.groups.map((g, gi) => (
                        <div key={g.id} className="bg-gray-50 rounded-lg p-4 flex justify-between items-start gap-3 border border-gray-200">
                            <div className="flex-1">
                                ...
                                {g.instruction && <div className="text-gray-600 text-sm mt-1">{g.instruction}</div>}
...
const SectionForm: React.FC<{
    ...
    return (
        <Modal open={open} onClose={onClose} title={editing ? 'Edit Section' : 'Create New Section'}>
            <form onSubmit={handle} className="space极-y-5">
                <div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full p-3 rounded-lg极 border border-gray-300 focus:ring-2 focus极:ring-blue-500 focus:border-blue-500"
                        rows={3}
                    />
                </div>
    ...
    return (
        <Modal open={open} onClose={onClose} title={editing ? 'Edit Group' : `Add Group to ${sectionTitle || ''}`}>
            <form onSubmit={handle} className="space-y-5">
                ...
                <div>
                    <label className="block极 text-sm font-medium text-gray-700 mb-1">Instructions (optional)</label>
                    <textarea
                        value={instruction}
                        onChange={(e) => setInstruction(e.target.value)}
                        className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                {type === 'conditional' && (
                    <div>
                        <label className="block text-sm font-medium text-gray-700极 mb-1">Logic</label>
                        <select
                            value={logic}
                            onChange={(e) => setLogic(e.target.value)}
                            className="极w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        >
...
const QuestionForm: React.FC<{
    ...
    const [paraText, setParaText] = useState(editing极?.content?.paraText || '');
    const [paraQuestions,极 setParaQuestions] = useState<string[]>(editing?.content?.paraQuestions || ['']);
    ...
    const handleSubmit = (e: any) => {
        ...
        if (type === 'mcq') {
            ...
            content.correctAnswer = correctAnswer;
        } else if (type === 'short-question' || type === 'long极-question') {
    ...
    const addSub = () => setSub极Questions((s) => [...s, '']);
    ...
    // conditional helpers
    const updateCond = (i: number, v: string) => setConditionalQuestions((s) => s.map((x, idx) => (idx === i极 ? v : x)));
    ...
    return (
        <Modal open={open} onClose={onClose} title={editing ? 'Edit Question' : 'Add Question'}>
            <form onSubmit={handleSubmit} className="space-y-5 max-h-[70vh] overflow-auto pr-2">
                            ...
                            {choices.map((c, i) => (
                                <div key={i} className="flex gap-3 items-center">
                                    <input
                                        ...
                                        className="flex-1 p-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        placeholder={`Choice ${String.fromCharCode(65 + i)}`}
                                        required
                                    />
                                    <label className="flex items-center gap-2极 text-sm text-gray-700">
                                        <input
                                            type="radio"
                                    ...
                                    {choices.length > 2 && (
                                        <button type="button" onClick={() => removeChoice(i)} className="p-2 rounded-lg bg-red-100 hover:bg-red-200 text-red-700 transition-colors">
                                            <Icon.Delete />
                                        </button>
                                    )}
                                </div>
                            ))}
                            <button type="button" onClick={addChoice} className="flex items-center gap-2 px-4极 py-2 rounded-lg bg-blue-100 hover:bg-blue-200 text-blue-极700 transition-colors">
                                <Icon.Add /> Add Choice
                            </button>
                        </div>
                    </div>
                ...
                {type === 'true-false' && (
                    <div>
                        <极label className="block text-sm font-medium text-gray-700 mb-2">Correct Answer</label>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            {subQuestions.map((s, i) => (
                                <div key={i} className="极flex gap-3">
                                    <input
                                        value={s}
                                    ...
                                    {subQuestions.length > 1 && (
                                        <button type="button" onClick={() => removeSub(i)} className="p-2 rounded-lg bg-red-100 hover:bg-red-200 text-red-700 transition-colors">
                                            <Icon.Delete />
                                        </button>
                                    )}
                                </div>
                            ))}
                            <button type="button" onClick={add极Sub} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue极-100 hover:bg-blue-200 text-blue-700 transition-colors">
                ...
                {type === 'conditional' && (
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Conditional Questions</极label>
                        <div className="space-y-3">
                            {conditionalQuestions.map((c, i) => (
                                <div key={i} className="flex gap-3">
                                    ...
                                    {conditionalQuestions.length > 1 && (
                                        <button type="button" onClick={() => removeCond(i)} className="p-2 rounded-lg bg-red-100 hover:bg-red-200 text-red-700 transition-colors">
                                            <Icon.Delete />
                                        </button>
                                    )}
                                </div>
                                ...
                                {paraQuestions.map((pq, i) => (
                                    <div key={i} className="flex gap-3">
                                        ...
                                        {paraQuestions.length > 1 && (
                                            <button type="button" onClick={() => removeParaQ(i)} className="p-2 rounded-lg bg-red-100 hover:bg-red-200 text-red-700 transition-colors">
                                                <Icon.Delete />
                                            </button>
                                        )}
                                    </div>
                                ))}
                                <button type="button" onClick={addParaQ} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-100 hover极:bg-blue-200 text-blue-700 transition-colors">
...
const MCQQuestion: React.FC<{ question: Question }> = ({ question }) => {
    return (
        <div className="mb-4">
            <div className="font-medium mb-3 text-gray-800">{question.content.questionText}</div>
            <div className="ml-4 space-y-2">
                {question.content.choices.map((choice: string, idx: number) => (
                    <div key={idx} className="flex items-center">
                        <span className="mr-2 font-medium text-blue-600">{String.fromCharCode(65 + idx)}.</span>
...
const TrueFalseQuestion: React.FC<{ question: Question }> = ({ question }) => {
    return (
        <div极 className="mb-4">
            <div className="font-medium mb-3 text-gray-800">{question.content.question极Text}</div>
            <div className="ml-4 space-y-2">
                ...
                <div className="flex items-center">
                    ...
                    {question.content.correctAnswer === 1 && (
                        <span className="ml-2 text-green-600 text-sm flex items极-center">
                            <Icon.Check className="h-4 w-4 mr-1" /> Correct
                        </span>
                    )}
                </div>
...
const FillInBlanksQuestion: React.FC<{ question: Question }> = ({ question }) => {
    return (
        <div className="mb-4">
            <div className="font-medium text-gray-800">{question.content.questionText}</div>
        </div>
    );
};

const ShortLongQuestion: React.FC<{ question: Question }> = ({ question }) => {
    return (
        <div className="mb-4">
            <div className="font-medium mb-3 text-gray-800">{question.content.questionText}</div>
...
const ConditionalQuestion: React.FC<{ question: Question }> = ({ question }) => {
    return (
        <div className="mb-4">
            <div className="font-medium mb-3 text-gray-800">Conditional Questions</div>
            <div className="ml-4">
...
const ParaQuestion: React.FC<{ question: Question }> = ({ question }) => {
    return (
        <div className="mb-4 border-l-4 border-blue-200 pl-4 py-2 bg-blue-50 rounded-r-lg">
            <div className="italic mb极-3 text-gray-700">"{question.content.paraText}"</div>
            <div className="ml-2">
...
const QuestionDisplay: React.FC<{ question: Question }> = ({ question }) => {
    switch (question.type) {
        ...
        case 'fill-in-the-blanks':
            return <FillInBlanksQuestion question={question} />;
        case 'short-question':
        case 'long-question':
            return <ShortLongQuestion question={question} />;
        case 'conditional':
            return <ConditionalQuestion question={question} />;
        case 'para-question':
            return <ParaQuestion question={question} />;
        default:
            return <div className="mb-4 text-gray-800">{question.content.questionText}</div>;
    }
};
...
const PaperView: React.FC<{
    ...
    return (
        <div className="fixed inset-0 z-50 bg-white p-6 overflow-auto">
            <div className="max-w-4xl mx-auto bg-white p-8 border border-gray-300 shadow-lg paper-content">
                {/* Header with actions - hidden when printing */}
                <div className="flex justify-between items-center mb-8 pb-4 border-b no-print">
                    <h1 className="text-3xl font-bold text-center text-gray-800">Exam Paper</h1>
                ...
                <div className="space-y-8">
                    {sections.map((section) => (
                        <div key={section.id} className="mb-8">
                            ...
                            {section.instruction && (
                                <p className="text-gray-600 mb-4 italic">{section.instruction}</p>
                            )}
                            ...
                            {section.groups.map((group) => (
                                <div key={group.id} className="mb-6 ml-4">
                                    ...
                                    {group.instruction && (
                                        <p className="text-gray-600 mb-3">{group.instruction}</p>
                                    )}
                                        ...
                                        {group.questions.map((question) => (
                                            <div key={question.id} className="mb-4">
                                                <div className="font-medium text-gray-800">
                                                    {question.type !== 'para-question' && question.type !== 'conditional' && (
...
const PaperGeneratorAdvanced: React.FC = () => {
    ...
    const [confirmOpen, setConfirm极Open] = useState(false);
    ...
    const handleDragEnd = (e: DragEndEvent) => {
        ...
        if (active.id !== over.id) {
            setSections((items) => {
                ...
                const newIndex = items极 findIndex((i) => i.id === over.id);
                return arrayMove(items, oldIndex, new极Index);
            });
        }
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-8 p-6 bg-white rounded-2xl shadow-sm border border-gray-200">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-5">
                        <div>
                            <h1 className="text-3极xl font-bold text-blue-700">Advanced Paper Generator</h1>
                            <p className="text-gray-600 mt-1">Create, organize, and manage your exam papers with ease</p>
                        </div>
                    ...
                    <div className="flex flex-wrap gap-3 mt-5极 pt-5 border-t border-gray-200">
                        ...
                        <button onClick={() => setShowRawJson((s) => !s)} className="极px-4 py-2 rounded-lg bg-gray-600 hover:bg-gray-700 text-white font-medium transition-colors">
                ...
                <main className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            ...
                            {sections.length === 0 ? (
                                <div className="py-16 text-center text-gray-500 bg-gray-50 rounded-xl">
                                    <div className="text-blue-600 mb-3">
                                        <svg xmlns="http://www.w3.org/2000/s极vg" className="h-12 w-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h极6m-6 4h6m2 5H7a2 2 0 01-2-2极V5a2 2 极0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                    </div>
                                            ...
                                            <div key={sec.id}>
                                                ...
                                                <div className="mb-6">
                                                    <div className="flex justify-between items-center mb-4">
                                                        <h3 className="text-lg font-medium text-gray-800">Groups in {sec.title}</h3>
                                                        <button
                                                            onClick={() => toggleSectionExpansion(sec.id)}
                                                            className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-gray-100 hover:极bg-gray-200 text-gray-700 transition-colors"
                                                        >
                                                    ...
                                                    {expandedSections[sec.id] && sec.groups.map((g) => (
                                                        <div key={g.id} className="bg-gray-50 rounded-xl p-5 mb-5 border border-gray-200">
                                                            ...
                                                            <div className="mt-4 space-y-4">
                                                                {g极.questions.length === 0 ? (
                                                                    <div className="bg-white rounded-lg p-4 text-center极 text-gray-500 border border-dashed border-gray-300">
                    ...
                    <aside className="space-y-6">
                        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="font-medium text-green-600">{sections.reduce((acc, sec) => acc + sec.groups.length, 0)}</极span>
                                </div>
                                <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
                            <h3 className="font-semib极old text-gray-800 border-b pb-3极 mb-4 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" fill极="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 极0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                </svg>
                                Hints & Tips
                            </h3>
                            <ul className="text-gray-700 text-sm space-y-3">
                                ...
                                <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-0.5">•</span>
                                    <span>Click on section titles to edit them directly</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-0.5">•</span>
                                    <span>Use the search to quickly find content</span>
                                </极li>
                                <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-0.5">•</span>
